<script lang="ts">
	...
	$: if (form?.success) dispatch('success');
						...
						>
								...
								<div class="bg-primary-600 px-4 py-6 sm:px-6">
									<div class="flex items-center justify-between">
										<h2 class="text-base font-semibold leading-6 text-white" id="slide-over-title">
											{#if edit}Stimmungsbild bearbeiten{:else}Neues Stimmungsbild{/if}
										</h2>
									...
									<div class="mt-1">
										<p class="text-sm text-primary-50">
											Du kannst zum Beispiel eine spezielle Frage stellen oder die allgemeine
											Stimmung bewerten lassen. Bewertet wird zwischen <span
												class="font-semibold text-white">0&nbsp;(schlecht)</span
											>
											und
													...
													<div class="relative flex items-start">
														...
														<div class="pl-7 text-sm leading-6">
															...
															<p id="state-closed-description" class="text-gray-500">
																Es kann aber erst abgestimmt werden, sobald du die Abstimmung
																öffnest.
															</p>
														</div>
													</div>
							...
							<div class="flex flex-shrink-0 justify-end px-4 py-4">
								<Button
									...
									scheme="white"
									disabled={formSubmitting}
									on:click={() => dispatch('cancelled')}>Abbrechen</Button
								>
								<Button submit={true} spinner={formSubmitting} class="ml-4"
									>{#if edit}Bearbeiten{:else}Erstellen{/if}</Button
								>
							</div>
						</form>
					</div>
