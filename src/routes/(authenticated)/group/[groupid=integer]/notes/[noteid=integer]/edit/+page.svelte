<script lang="ts">
	...
	let content: string = data.note.note;
...
>
	...
	<div class="mt-2 flex justify-end gap-x-2">
		<Button href="/group/{data.group?.id}/notes/{data.note.id}" scheme="secondary">Abbrechen</Button
		>
		<Button submit={true} spinner={formSubmitting} scheme="primary">Speichern</Button>
	</div>
</form>
