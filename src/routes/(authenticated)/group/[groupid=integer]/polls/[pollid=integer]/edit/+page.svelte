<script lang="ts">
	...
	$: pollTitle = data.poll_details.question;
					...
					>
								...
								<div class="flex items-center justify-between">
									...
									<div class="ml-3 flex h-7 items-center">
										<a
											...
											href="/group/{data.group?.id}/polls/{data.poll_details.id}"
										>
												...
												<div class="relative flex items-start">
													<div class="absolute flex h-6 items-center">
														<input
															...
															value="closed"
															checked={!data.poll_details.open}
															disabled={formSubmitting}
															required
														/>
													</div>
												...
												<div class="relative flex items-start">
													<div class="flex h-6 items-center">
														<input
															...
															checked={data.poll_details.autoClose}
															disabled={formSubmitting}
														/>
													</div>
						...
						<div class="flex flex-shrink-0 justify-end px-4 py-4">
							<Button
								submit={false}
								scheme="white"
								href="/group/{data.group?.id}/polls/{data.poll_details.id}">Abbrechen</Button
							>
							<Button submit={true} spinner={formSubmitting} class="ml-4">Bearbeiten</Button>
						</div>
					</form>
				</div>
			</div>
